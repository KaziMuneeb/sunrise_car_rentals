    ...
    <div className="">
      ...
      <div>
        <div className="relative sm:flex sm:justify-center">
          <ul className=" flex flex-col sm:flex-row    bg-bg-grey  sm:bg-inherit space-y-5 p-5  sm:w-11/12 sm:mx-auto sm:gap-10  sm:justify-center sm:px-60 sm:absolute sm:-top-24">
        ...
        <div className="">
          <form className="grid grid-cols-2 gap-3">
            ...
            <textarea
              type="text"
              placeholder="Message"
              className=" col-span-full p-2 rounded-lg sm:bg-bg-grey sm:p-5"
            />
            <button className=" bg-vivid-orange  p-2 rounded-lg">Submit</button>
          </form>
        </div>
